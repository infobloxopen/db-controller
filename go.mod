...
require (
	...
	github.com/crossplane-contrib/provider-aws v0.45.0-rc.0
	...
	github.com/upbound/provider-gcp v1.11.0
...
require (
	...
	github.com/crossplane/upjet v1.4.1-0.20241007154751-5cdf36996e4a // indirect
