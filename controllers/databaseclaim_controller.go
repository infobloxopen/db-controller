...
func (r *DatabaseClaimReconciler) getClientForExistingDB(dbClaim *persistancev1.DatabaseClaim, connInfo *persistancev1.DatabaseClaimConnectionInfo) (dbclient.Client, error) {
