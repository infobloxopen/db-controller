...
func (in *SchemaStatus) DeepCopyInto(out *SchemaStatus) {
	*out = *in
	if in.UsersStatus != nil {
		in, out := &in.UsersStatus, &out.UsersStatus
		*out = make([]UserStatusType, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SchemaUserClaimSpec) DeepCopyInto(out *SchemaUserClaimSpec) {
	*out = *in
	...
	if in.Schemas != nil {
		...
		*out = make(map[string][]UserType, len(*in))
